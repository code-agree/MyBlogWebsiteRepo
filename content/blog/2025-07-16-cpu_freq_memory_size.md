...
- **功耗和发热呈超线性增长（P = CV²f，与频率和电压呈多项式关系）**：频率提升带来的功耗增加可能导致热节流，反而影响稳定性
...
| DDR3 | 2007 | 800-1066MHz | 1600-2133 MT/s | 1.5V | 8n |
| DDR4 | 2014 | 1066-1600MHz | 2133-3200 MT/s | 1.2V | 8n |
| DDR5 | 2020 | 2400-3600MHz | 4800-7200 MT/s | 1.1V | 16n |
...
// 真实延迟计算：
// 真实延迟 = CL / 基础频率 = CL × 2 / 数据率
// DDR4-3200 CL14: 14 × 2 / 3200 = 8.75ns
// DDR4-2133 CL15: 15 × 2 / 2133 = 14.06ns
```
